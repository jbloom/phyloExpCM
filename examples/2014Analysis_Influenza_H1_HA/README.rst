...
.. figure:: CodonPhyML_Tree_H1_HumanSwine_GY94/annotated_tree.jpg
   :width: 65%
   :align: center
...
.. figure:: CodonPhyML_Tree_H1_HumanSwine_KOSI07/annotated_tree.jpg
   :width: 65%
   :align: center
...
.. figure:: evolutionary_frequencies/sequential_numbering_combined_evolequilfreqs_site_preferences_logoplot.jpg
   :width: 65%
   :align: center
...
.. figure:: frequency_correlations/natural_frequency_vs_preference.jpg
   :width: 35%
   :align: center
...
.. include:: H1_HumanSwine_GY94_summary.csv
   :literal:

Here are the results for the *KOSI07* tree topology:

.. include:: H1_HumanSwine_KOSI07_summary.csv
   :literal:
