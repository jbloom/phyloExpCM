...
def main():
    ...
    nperyearhostsubtype = 3 # keep this many per year / host / subtype
    ...
    refseqfile = 'WSN-HA.fasta' # sequence to which we align
    infile = 'H1_HAseqs.fasta' # input file with all sequences
    outfile = 'H1_HumanSwine_alignment.fasta' # output file
    anomalies = frozenset([line.strip() for line in open('JVI_82_8947_Anomalies.txt').readlines() + open('JDB_Anomalies.txt').readlines() if not line.isspace()]) # strain names of anomalous sequences
