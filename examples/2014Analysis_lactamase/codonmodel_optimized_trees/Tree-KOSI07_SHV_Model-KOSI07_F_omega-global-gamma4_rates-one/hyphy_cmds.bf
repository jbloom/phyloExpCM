...
DataSet data = ReadDataFile("_codenames_aligned_KOSI07_SHV.fasta");
assert(data.sites % 3 == 0, "Sequence lengths not multiples of 3");
totalcodons = data.sites $ 3;
fprintf(stdout, "Read from _codenames_aligned_KOSI07_SHV.fasta a set of ", data.species, " sequences consisting of ", data.sites, " nucleotides corresponding to ", totalcodons, " codons each.\n");
...
fprintf(stdout, "Reading tree string from _codenames_codonphyml_tree_SHV.newick.\n");
fscanf("_codenames_codonphyml_tree_SHV.newick", String, treestring);
...
CreateKOSI07Model("F", "ktv", "global", 4, 1, 1, "/home/jbloom/.local/lib/python2.7/site-packages/phyloExpCM/data//KOSI07_exchangeabilities.ibf");
UseModel(model);
